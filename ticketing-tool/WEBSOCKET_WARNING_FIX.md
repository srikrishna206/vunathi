...
```
WebSocket connection to 'ws://3.135.229.169:3000/ws' failed: Error in connection establishment: net::ERR_CONNECTION_REFUSED
```
...
1. **Test Registration:**
   - Go to http://3.135.229.169:3000/login
   - Click "Registration"

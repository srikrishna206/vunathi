...
```env
DATABASE_URL=postgresql+asyncpg://postgres:YOUR_PASSWORD@3.135.229.169:5432/flow
...
**Database URL in .env:**
```
DATABASE_URL=postgresql+asyncpg://postgres:postgres@3.135.229.169:5432/flow
```

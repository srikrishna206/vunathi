...
```python
# config.py
database_url: str = "postgresql+asyncpg://postgres:12345@3.135.229.169:5432/flow"
```

### After (Using .env):
```python
# config.py
database_url: str = "postgresql+asyncpg://postgres:12345@3.135.229.169:5432/flow"  # default fallback
